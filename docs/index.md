...
- Guides
    ...
    - [Card transactions](./guides/card_transactions/)
    - [Fiscal sponsorship fees](./guides/fees/)
    - [Fronted transactions](./guides/fronted_transactions/)
    - [Reimbursements in the transaction engine](./guides/reimbursements_transaction_engine/)
    - [Stripe payouts & fee reimbursements](./guides/stripe_payouts/)
    - [Stripe service fees](./guides/stripe_service_fees/)
    - [Transaction imports](./guides/transaction_imports/)
    - [Wires](./guides/wires/)
...
Let's get the HCB codebase set up on your computer! We have setup a easy and simple [guide](./development/) for you to get it running on your computer!
